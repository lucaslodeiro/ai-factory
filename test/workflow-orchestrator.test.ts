...
class GitHub {
 ...
 comments(n:number){return this.commentsByIssue.get(n)??[];}authenticatedLogin(){return "factory";}assignedIssues(){return [];}ensureLabel(){}addLabel(){}removeLabel(){}replaceInstanceLabel(){}
