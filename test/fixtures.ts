...
export function result(outcome: AgentResult["outcome"], more: Partial<AgentResult> = {}): AgentResult {
 return { taskAssessment: outcome === "spec" ? { complexity: "medium", risk: "low", verificationDepth: "standard", uxImpact: "none", rationale: "Localized feature with standard tests" } : null, outcome, summary: "Evidence: tests executed", brief: outcome === "spec" ? "## Decisions for you\nNone.\n\n## Solution\nReturn 42." : "", spec: outcome === "spec" ? "# Specification\nAC1: returns 42" : "",
