...
export function result(outcome: AgentResult["outcome"], more: Partial<AgentResult> = {}): AgentResult {
 return { taskAssessment: outcome === "spec" ? { complexity: "medium", risk: "low", rationale: "Localized feature with standard tests" } : null, outcome, summary: "Evidence: tests executed", spec: outcome === "spec" ? "# Specification\nAC1: returns 42" : "",
