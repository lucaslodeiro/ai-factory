...
for(const name of ['dist/src/cli.js','dist/src/storage.js','dist/src/github-runtime.js','dist/src/github-worker.js','dist/src/worker-supervisor.mjs','dist/src/browser-runner.mjs','dist/scripts/benchmark-verify.mjs','dist/dashboard/index.html']){
...
try{
 ...
 if(error instanceof Error&&error.message.includes('Unsupported AI Factory database schema')){console.error('Incompatible database schema: uninstall and reinstall with an empty data directory');process.exitCode=1;}
 else throw error;
}
