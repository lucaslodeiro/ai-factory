...
export function backgroundGitHub():{github:RuntimeGitHub;close:()=>Promise<number>} {
 ...
 const methods=new Set(['pullRequestState','authenticatedLogin','assignedIssues','issue','comments','repository','ensureLabel','addLabel','removeLabel','replaceInstanceLabel','ensurePR','syncWorkflow','publishWorkflowComment','editComment','assignees','assign','unassign']);
