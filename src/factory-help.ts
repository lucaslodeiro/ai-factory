...
- \`/factory replace <guidance-id> [--issue] [--for <roles>] <text>\` — replace active guidance. Example: \`/factory replace ab12cd34 Use WebKit\`.
- \`/factory revoke <guidance-id>\` — revoke active guidance. Example: \`/factory revoke ab12cd34\`.
