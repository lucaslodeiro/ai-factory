...
const descriptions: Record<string,Omit<Field,"key">> = {
  ...
  FACTORY_ISSUE_BUDGET_TOKENS:{label:"Shared token budget",description:"One budget of provider-reported tokens, cache included, covers the epic and every story. An approver can extend it for the whole family.",group:"limits",type:"number",unit:"tokens",restart:"daemon"},
