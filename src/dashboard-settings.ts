...
const descriptions: Record<string,Omit<Field,"key">> = {
  ...
  FACTORY_ISSUE_BUDGET_TOKENS:{label:"Shared token budget",description:"One cost-weighted budget covers the epic and every story. Cached reads count at a discount; an approver can extend it for the whole family.",group:"limits",type:"number",unit:"tokens",restart:"daemon"},
