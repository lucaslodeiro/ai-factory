...
- Not verified: the dashboard was not opened in a browser during this round. Badge markup and styles were checked through the vm-based rendering tests and `node --check` only.
